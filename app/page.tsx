...
const images = ["/attend1-1.jpg", "/attend2-1.jpg", "/attend3-1.jpg", "/attend4-1.jpg"];
...
<SpeakersIntro
  speakers={[
    { name: "Brooklyn Simmons", role: "Design Researcher", img: "/attend2-1.jpg" },
    { name: "Jenny Wilson", role: "UX Designer", img: "/attend3-1.jpg" },
    { name: "Devon Lane", role: "Design Strategist", img: "/attend4-1.jpg" },
  ]}
  logos={[
    { src: "/brands/microsoft.svg", alt: "Microsoft" },
    { src: "/brands/ikea.svg", alt: "IKEA" },
    { src: "/brands/alexa.svg", alt: "Alexa" },
    { src: "/brands/google.svg", alt: "Google" },
    { src: "/brands/logitech.svg", alt: "Logitech" },
    { src: "/brands/adobe.svg", alt: "Adobe" },
  ]}
/>
